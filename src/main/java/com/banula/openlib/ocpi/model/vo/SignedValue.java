...
/**
 * This class contains the signed and the plain/unsigned data. By decoding the
 * data, the receiver can check
...
public class SignedValue {
     ...
     * - Intermediate (signed values taken during the Session, after Start, before
     * End)
