 ...
 * The category has
 * to be set accordingly to the image content in order to guarantee the right
 * usage.
 */
public enum ImageCategory {
    ...
    OTHER,
    /**
     * Logo of the charge point owner, for example a local store, to be displayed in
     * the EVSEs detailed
     * information view
     */
    OWNER
