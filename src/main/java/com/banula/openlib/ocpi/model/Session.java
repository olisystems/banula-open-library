...
public class Session {
    ...
    /**
     * The timestamp when the session became ACTIVE in the Charge Point. When the
     * session is still PENDING,
     * this field SHALL be set to the time the Session was created at the Charge
     * Point. When a Session goes from PENDING
    ...
    /**
     * Method used for authentication. This might change during a session, for
     * example when the session was started
     * with a reservation: ReserveNow: COMMAND. When the driver arrives and starts
     * charging using a Token that
    ...
    /**
     * Location.id of the Location object of this CPO, on which the charging session
     * is/was happening.
     */
    ...
    /**
     * EVSE.uid of the EVSE of this Location on which the charging session is/was
     * happening.
     * Allowed to be set to: #NA when this session is created for a reservation, but
     * no EVSE yet assigned to the driver.
     */
    ...
    /**
     * Connector.id of the Connector of this Location where the charging session
     * is/was happening.
     * Allowed to be set to: #NA when this session is created for a reservation, but
     * no connector yet assigned
     * to the driver.
     */
    ...
    /**
     * The total cost of the session in the specified currency. This is the price
     * that the eMSP will have to pay
     * to the CPO.
     */
