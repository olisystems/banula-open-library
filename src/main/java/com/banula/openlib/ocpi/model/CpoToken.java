...
public class CpoToken {
    ...
    /**
     * Unique ID by which this Token, combined with the Token type, can be
     * identified.
     * This is the field used by CPO system (RFID reader on the Charge Point) to
     * identify this token.
     * Currently, in most cases: type=RFID, this is the RFID hidden ID as read by
     * the RFID reader, but that is not
     * a requirement. If this is a APP_USER or AD_HOC_USER Token, it will be a
     * uniquely, by the eMSP, generated ID.
     ...
     * Recommended to follow the specification for eMA ID from "eMI3 standard
     * version
     * V1.0" (<a href="http://emi3group.com/documents-links/">...</a>) "Part 2:
     * business objects."
     */
    ...
    /**
     * Issuing company, most of the time the name of the company printed on the
     ...
     * handy when a card and key-fob
     * are given to the EV-driver. Beware that OCPP 1.5/1.6 only support group_ids
     * (it is called parentId in OCPP
     ...
     * If the language is not provided or not supported then the CPO is free to
     * choose its own language
     */
    private String language;

    /**
     * The default Charging Preference. When this is provided, and a charging
     * session is started on an Charge Point
     * that support Preference base Smart Charging and support this ProfileType, the
     * Charge Point can start using
     * this ProfileType, without this having to be set via: Set Charging
     * Preferences.
     */
     ...
     * NOTE: In a lot of countries it is currently not allowed/possible to use a
     * drivers own energy supplier/contract
     * at a Charge Point.
     */
