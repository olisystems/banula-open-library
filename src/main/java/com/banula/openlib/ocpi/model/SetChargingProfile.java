...
import com.banula.openlib.ocpi.model.vo.ChargingProfile;
...
public class SetChargingProfile {
    ...
    /**
     * URL that the ChargingProfileResult POST should be sent to. This URL might
     * contain a unique ID to be able
