...
public class CdrLocation {
     ...
     * version V1.0"
     * (<a href="http://emi3group.com/documents-links/">...</a>) "Part 2: business
     * objects.".
     * Allowed to be set to: #NA when this CDR is created for a reservation that
     * never resulted in a charging session.
     */
    ...
    /**
     * Identifier of the connector within the EVSE. Allowed to be set to: #NA when
     * this CDR is created
     ...
     * reservation that never resulted
     * in a charging session, this field can be set to any value and should be
    ...
    /**
     * The format (socket/cable) of the installed connector. When this CDR is
     * created for a reservation that
     * never resulted in a charging session, this field can be set to any value and
