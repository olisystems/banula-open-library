package com.banula.openlib.ocpi.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<OcpiErrorResponse> handleCustomExceptionHandler(HttpMessageNotReadableException e) {
        return ResponseEntity.badRequest()
                .body(new OcpiErrorResponse(e.getMessage(), Constants.STATUS_CODE_INVALID_OR_MISSING_PARAMETERS));
    }
    ...
    public ResponseEntity<OcpiErrorResponse> handleCustomExceptionHandler(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity.ok()
                .body(new OcpiErrorResponse(errorResponse, Constants.STATUS_CODE_INVALID_OR_MISSING_PARAMETERS));
    }
