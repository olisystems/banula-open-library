...
import com.banula.openlib.ocn.model.RewriteVerifyResult;
...
public class Rewrite {
    ...
    public RewriteVerifyResult verify(List<String> fields, ValuesToSign<?> modifiedValues, DocumentContext jsonPath,
