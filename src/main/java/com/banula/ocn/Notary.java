...
public class Notary {
    ...
    // verify signature that comes from the other party, or from OCN node in case of changing body content (Sessions module for example)
    // TODO use a requests of sessions module to test if signature comes from OCN node indeed and other fields are nested in the body
        ...
        if (value != null && !"".equals(value)) {
            if (value instanceof List) {
                ...
                try {
                    ...
                    Map<String, Object> valueAsMap = objectMapper.readValue(valueAsJsonString, new TypeReference<Map<String, Object>>() {});
