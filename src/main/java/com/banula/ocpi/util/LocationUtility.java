...
public abstract  class LocationUtility {
    ...
    3 - when evseUid and connectorId are both nonNull we return a Connector object
     */
    public Object findLocations(String countryCode, String party_id, String locationId, String evseUid, String connectorId, String collectionName) {
    ...
    public List<LocationDTO> findLocations(LocalDateTime dateFrom, LocalDateTime dateTo, Integer offset, Integer limit, String collectionName) {
