...
import com.banula.openlib.ocpi.model.enums.AvailableFlexibility;
...
public class LocationMapperTest {
    ...
    void generateLocation_from_LocationDTO() {
        ...
        Assertions.assertEquals(Double.parseDouble(locationDTO.getCoordinates().getLatitude()),
                result.getCoordinates().getCoordinates().get(0));
        Assertions.assertEquals(Double.parseDouble(locationDTO.getCoordinates().getLongitude()),
                result.getCoordinates().getCoordinates().get(1));
