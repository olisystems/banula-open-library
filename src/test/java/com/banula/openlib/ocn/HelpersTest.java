...
import com.banula.openlib.ocn.model.SignableHeaders;
...
public class HelpersTest {
    ...
    private static Credentials credentials = Credentials
            .create("0x0138006a73a6187729ef2a4acfcd39b5d5dfb4f28a37c7911113ae380b51b5d5");
    ...
    public void test_verifyRequest_linkedHashMap() throws Exception {
        ...
        // "";
        //
    ...
    public void test_verifyRequest_genericObject() throws Exception {
        ...
        // body.id = "1";
        //
        // ValuesToSign values = new ValuesToSign(headers.toSingleValueMap(), body,
        // null);
        //
        // Notary notary = new Notary();
        // String signature = notary.sign(values, privateKey).serialize();
