...
import com.banula.ocpi.mapper.CommandResultMapper;
import com.banula.ocpi.model.dto.request.CommandResultRequestDTO;
import com.banula.ocpi.model.enums.CommandResultType;
import com.banula.ocpi.model.vo.CommandResult;
...
class CommandResultMapperTest {
    ...
    void testToListCommandResultDTO() {
        ...
        List<CommandResultRequestDTO> commandResultDTOList = CommandResultMapper.toListCommandResultDTO(commandResultList);
    ...
    void testToListCommandResultEntity() {
        ...
        assertEquals(commandResultRequestDTO.getMessage().getLanguage(), commandResultList.get(0).getMessage().getLanguage());
    }
