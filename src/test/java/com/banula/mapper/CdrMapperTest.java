...
import com.banula.ocpi.mapper.CdrMapper;
...
import com.banula.ocpi.model.enums.*;
        ...
        cdrDTO = CdrDTO.builder()
                ...
                .tariffs(Collections.singletonList(Tariff.builder()
                        ...
                        .elements(Collections.singletonList(new TariffElement(
                                Collections.singletonList(
                                        new PriceComponent(TariffDimensionType.ENERGY, 0.20f, 1)
                                ))))
                ...
                .chargingPeriods(Collections.singletonList(
                        new ChargingPeriod(
                                ...
                                Collections.singletonList(new CdrDimension(CdrDimensionType.ENERGY, 50.0f)),
                                "tariff123")))
                .signedData(SignedData.builder()
                        .encodingMethod("SHA256")
                        .encodingMethodVersion(1)
                        .publicKey("publicKey123")
                        .signedValues(Collections.singletonList(new SignedValue("End", "plainData123", "signedData123")))
